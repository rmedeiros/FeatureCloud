 ...
 $( function() {
    $( "#slider-scattering" ).slider({
      ...
      slide: function( event, ui ) {
        $( "#amountScattering" ).val( ui.value );
      }
    });
    $( "#amountScattering" ).val( $( "#slider-scattering" ).slider( "value" ) );
    ...
    $( "#slider-tangling" ).slider({
        ...
        value: 60,
        slide: function( event, ui ) {
          $( "#amountTangling" ).val( ui.value );
        }
      });
      $( "#amountTangling" ).val( $( "#slider-tangling" ).slider( "value" ) );
  } );
