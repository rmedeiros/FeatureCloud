// Generated by CoffeeScript 1.9.3
 ...
 $( function() {
	 ...
	 var scatteringMap = Array.from(new Set(features.map(feature => feature.featureScattering))).sort(compareInt);
    ...
    $( "#amountScattering" ).val( 1 );
	 ...
	 var tanglingMap = Array.from(new Set(features.map(feature => feature.tangling))).sort(compareInt);
