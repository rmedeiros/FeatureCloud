...
(function () {
    $(document).ready(function () {
        ...
        plotPhylogeny = function (options) {
            var _edges, _labels, a, b, bbox, color, drag, dragmove, edge_color, edge_scale, edge_width, edges, fontsize,
                fx, fy, get_text_size, height, i, j, l, label_color, label_fontsize, label_offset, labelcolors, labels,
                labelscales, len, len1, len2, len3, len4, line, m, n, nl, nodes, o, outheight, outwidth, p, pad,
                parse_input, parse_labelcolors, parse_labelscales, q, ref, ref1, ref2, ref3, resolve, svg, tmp, tree,
                width, x, y;
            ...
            _labels = svg.append("g").selectAll("a").data(labels).enter().append("a").attr("href", function (d) {
            ...
            svg.selectAll("g").attr("transform", "translate(" + (pad - x + 2) + "," + (pad - y - 2) + ")");
