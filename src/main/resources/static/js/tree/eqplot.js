  ...
  $(document).ready(function() {
    ...
    plotPhylogeny = function(options) {
      var _edges,
        ...
        y;
      (ref = options["default"]),
        (label_fontsize = ref.label_fontsize),
        (label_color = ref.label_color),
        (label_offset = ref.label_offset),
        (edge_width = ref.edge_width),
        (edge_color = ref.edge_color),
        (edge_scale = ref.edge_scale);
      ...
      get_text_size = function(string, fontsize) {
        ...
        (ref1 = tmp[0][0].getBoundingClientRect()),
          (width = ref1.width),
          (height = ref1.height);
        return [width, height];
      };
      ...
      resolve = function(a, b) {
        ...
        if (
          hori_overlap / (a.width + b.width) <
          vert_overlap / (a.height + b.height)
        ) {
          if (a.x <= b.x) {
            a.lx -= hori_overlap / 2;
