...
!(function(a) {
  ...
  k.prototype = {
    ...
    getClassNames: function(b) {
      ...
      return (
        b.getUTCFullYear() < d ||
        (b.getUTCFullYear() === d && b.getUTCMonth() < e)
          ? c.push("old")
          : (b.getUTCFullYear() > d ||
              (b.getUTCFullYear() === d && b.getUTCMonth() > e)) &&
            c.push("new"),
        ...
        this.o.todayHighlight &&
          b.getUTCFullYear() === f.getFullYear() &&
          b.getUTCMonth() === f.getMonth() &&
          b.getUTCDate() === f.getDate() &&
          c.push("today"),
        ...
        for (var u, v = []; p.valueOf() < t; ) {
          if (
            ...
            var w = new Date(
              ...
              y = new Date(
                Number((y = c(x.getUTCFullYear(), 0, 1))) +
        ...
        e.hasClass("disabled") ||
          ...
          e.hasClass("month") &&
            ...
            1 === this.o.minViewMode
              ? (this._setDate(c(h, i, g)), this.showMode())
              : this.showMode(-1),
            this.fill()),
          (e.hasClass("year") ||
            e.hasClass("decade") ||
        ...
        if (
          ...
          for (n = 0; n < y.length; n++)
            (D = y[n]),
              D in x &&
                !isNaN(x[D]) &&
                ((C = new Date(e)), z[D](C, x[D]), isNaN(C) || (e = C));
        }
        return e;
      },
