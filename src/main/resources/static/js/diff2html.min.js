!(function e(t, n, r) {
...
})(
  {
            ...
            return (function(modules) {
              ...
              function(module, exports, __webpack_require__) {
                ...
                var obj,
                  ...
                  _base2 =
                    (obj = _base) && obj.__esModule ? obj : { default: obj },
              ...
              function(module, exports) {
                ...
                (exports.__esModule = !0),
                  ((exports.default = Diff).prototype = {
                    diff: function(oldString, newString) {
                      ...
                      (oldString = this.castInput(oldString)),
                        ...
                        (oldString = this.removeEmpty(
                          this.tokenize(oldString)
                        ));
                      var newLen = (newString = this.removeEmpty(
                          this.tokenize(newString)
                        )).length,
                      ...
                      if (callback)
                        !(function exec() {
                          setTimeout(function() {
                            if (maxEditLength < editLength) return callback();
                            execEditLength() || exec();
                          }, 0);
                        })();
                      else
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffChars = function(oldStr, newStr, options) {
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffWords = function(oldStr, newStr, options) {
                    return (
                  ...
                  (exports.diffWordsWithSpace = function(
                    oldStr,
                    newStr,
                    options
                  ) {
                ...
                var extendedWordChars = /^[A-Za-z\xC0-\u02C6\u02C8-\u02D7\u02DE-\u02FF\u1E00-\u1EFF]+$/,
                  reWhitespace = /\S/,
                  wordDiff = (exports.wordDiff = new _base2.default());
                (wordDiff.equals = function(left, right) {
                  ...
                  (wordDiff.tokenize = function(value) {
                    for (
                      var tokens = value.split(/(\s+|\b)/), i = 0;
                      i < tokens.length - 1;
                      i++
                    )
                      !tokens[i + 1] &&
              ...
              function(module, exports) {
                "use strict";
                (exports.__esModule = !0),
                  (exports.generateOptions = function(options, defaults) {
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffLines = function(oldStr, newStr, callback) {
                    return lineDiff.diff(oldStr, newStr, callback);
                  }),
                  (exports.diffTrimmedLines = function(
                    oldStr,
                    newStr,
                    callback
                  ) {
                ...
                lineDiff.tokenize = function(value) {
                  ...
                  linesAndNewlines[linesAndNewlines.length - 1] ||
                    linesAndNewlines.pop();
                  for (var i = 0; i < linesAndNewlines.length; i++) {
                    var line = linesAndNewlines[i];
                    i % 2 && !this.options.newlineIsToken
                      ? (retLines[retLines.length - 1] += line)
                      : (this.options.ignoreWhitespace && (line = line.trim()),
                        retLines.push(line));
                  }
                  return retLines;
                };
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffSentences = function(oldStr, newStr, callback) {
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffCss = function(oldStr, newStr, callback) {
              ...
              function(module, exports, __webpack_require__) {
                "use strict";
                (exports.__esModule = !0), (exports.jsonDiff = void 0);
                var _typeof =
                ...
                (exports.diffJson = function(oldObj, newObj, options) {
                ...
                var objectPrototypeToString = Object.prototype.toString,
                  jsonDiff = (exports.jsonDiff = new _base2.default());
                function canonicalize(
                  ...
                  if ("[object Array]" === objectPrototypeToString.call(obj)) {
                    ...
                    return (
                      stack.pop(), replacementStack.pop(), canonicalizedObj
                    );
                  }
                  if (
                    ...
                    var sortedKeys = [],
                      _key = void 0;
                    for (_key in obj)
                      obj.hasOwnProperty(_key) && sortedKeys.push(_key);
                    for (
                      sortedKeys.sort(), i = 0;
                      i < sortedKeys.length;
                      i += 1
                ...
                (jsonDiff.useLongestToken = !0),
                  ...
                  (jsonDiff.equals = function(left, right) {
                    return _base2.default.prototype.equals.call(
                      jsonDiff,
                      left.replace(/,([\r\n])/g, "$1"),
                      right.replace(/,([\r\n])/g, "$1")
                    );
              ...
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.diffArrays = function(oldArr, newArr, callback) {
              ...
              function(module, exports, __webpack_require__) {
                ...
                var obj,
                  ...
                  _distanceIterator2 =
                    (obj = _distanceIterator) && obj.__esModule
                      ? obj
                      : { default: obj };
                function applyPatch(source, uniDiff) {
                  ...
                  function hunkFits(hunk, toPos) {
                    for (var j = 0; j < hunk.lines.length; j++) {
                      var line = hunk.lines[j],
                        operation = 0 < line.length ? line[0] : " ",
                        content = 0 < line.length ? line.substr(1) : line;
                  ...
                  for (var i = 0; i < hunks.length; i++) {
                    for (
                      var hunk = hunks[i],
                        ...
                        iterator = (0, _distanceIterator2.default)(
                          toPos,
                          minLine,
                          maxLine
                        );
                  ...
                  for (var diffOffset = 0, _i = 0; _i < hunks.length; _i++) {
                    var _hunk = hunks[_i],
                    ...
                    for (var j = 0; j < _hunk.lines.length; j++) {
                      ...
                      if (" " === operation) _toPos++;
                        ...
                        lines.splice(_toPos, 1), delimiters.splice(_toPos, 1);
                      else if ("+" === operation)
                  ...
                  else addEOFNL && (lines.push(""), delimiters.push("\n"));
                  ...
                  (exports.parsePatch = function(uniDiff) {
                    ...
                    function parseIndex() {
                      ...
                      for (
                        ...
                        if (/^@@/.test(_line)) index.hunks.push(parseHunk());
                        else {
                    ...
                    function parseHunk() {
                      for (
                        ...
                        var operation =
                          0 == diffstr[i].length && i != diffstr.length - 1
                            ? " "
                            : diffstr[i][0];
                        if (
                          "+" !== operation &&
                    ...
                    for (; i < diffstr.length; ) parseIndex();
                    return list;
                  });
              },
              function(module, exports) {
                    ...
                    return function iterator() {
                      ...
                      if (!backwardExhausted)
                        return (
                          ...
                          minLine <= start - localOffset
                            ? -localOffset++
                            : ((backwardExhausted = !0), iterator())
                        );
                    };
                  });
              },
              function(module, exports, __webpack_require__) {
                ...
                (exports.__esModule = !0),
                  ...
                  (exports.merge = function(mine, theirs, base) {
                    ...
                    (mine.newFileName || theirs.newFileName) &&
                      (fileNameChanged(mine)
                        ? fileNameChanged(theirs)
                        ...
                        : ((ret.oldFileName =
                            theirs.oldFileName || mine.oldFileName),
                          (ret.newFileName =
                            theirs.newFileName || mine.newFileName),
                          (ret.oldHeader = theirs.oldHeader || mine.oldHeader),
                          (ret.newHeader =
                            theirs.newHeader || mine.newHeader)));
                    ret.hunks = [];
                    var mineIndex = 0,
                      theirsIndex = 0,
                      mineOffset = 0,
                    ...
                    for (
                      ...
                      if (hunkBefore(mineCurrent, theirsCurrent))
                        ret.hunks.push(cloneHunk(mineCurrent, mineOffset)),
                          mineIndex++,
                          (theirsOffset +=
                            mineCurrent.newLines - mineCurrent.oldLines);
                      else if (hunkBefore(theirsCurrent, mineCurrent))
                        ret.hunks.push(cloneHunk(theirsCurrent, theirsOffset)),
                          theirsIndex++,
                          (mineOffset +=
                            theirsCurrent.newLines - theirsCurrent.oldLines);
                      else {
                        var mergedHunk = {
                          oldStart: Math.min(
                ...
                function calcLineCount(hunk) {
                  var _calcOldNewLineCount = (function calcOldNewLineCount(
                      lines
                    ) {
                      var oldLines = 0;
                      var newLines = 0;
                      lines.forEach(function(line) {
                        if ("string" != typeof line) {
                          ...
                          void 0 !== oldLines &&
                            (myCount.oldLines === theirCount.oldLines
                              ? (oldLines += myCount.oldLines)
                              : (oldLines = void 0)),
                            void 0 !== newLines &&
                              (myCount.newLines === theirCount.newLines
                ...
                function loadPatch(param, base) {
                  ...
                  return (0, _create.structuredPatch)(
                    void 0,
                    void 0,
                    base,
                    param
                ...
                function fileNameChanged(patch) {
                  return (
                    patch.newFileName && patch.newFileName !== patch.oldFileName
                  );
                }
                function selectField(index, mine, theirs) {
                  return mine === theirs
                    ? mine
                    : ((index.conflict = !0), { mine: mine, theirs: theirs });
                }
                  ...
                  for (
                    ...
                    if (
                      ...
                      if ("+" === mineCurrent[0] && " " === theirCurrent[0]) {
                        ...
                        "-" === mineCurrent[0] && " " === theirCurrent[0]
                          ? removal(hunk, mine, their)
                          : "-" === theirCurrent[0] && " " === mineCurrent[0]
                          ? removal(hunk, their, mine, !0)
                          : mineCurrent === theirCurrent
                    ...
                    else mutualChange(hunk, mine, their);
                  }
                ...
                function mutualChange(hunk, mine, their) {
                  ...
                  if (allRemoves(myChanges) && allRemoves(theirChanges)) {
                    ...
                    if (
                      ...
                      return void (_hunk$lines3 = hunk.lines).push.apply(
                        _hunk$lines3,
                    ...
                    if (
                      ...
                      return void (_hunk$lines4 = hunk.lines).push.apply(
                        _hunk$lines4,
                        _toConsumableArray(theirChanges)
                      );
                  } else if ((0, _array.arrayEqual)(myChanges, theirChanges)) {
                    var _hunk$lines5;
                    return void (_hunk$lines5 = hunk.lines).push.apply(
                      _hunk$lines5,
                      _toConsumableArray(myChanges)
                    );
                  }
                ...
                function removal(hunk, mine, their, swap) {
                  var _hunk$lines6,
                    myChanges = collectChange(mine),
                    theirChanges = (function(state, matchChanges) {
                      var changes = [],
                        merged = [],
                        matchIndex = 0,
                        contextChanges = !1,
                      ...
                      for (
                        ...
                        match.substr(1) === change.substr(1)
                          ? (changes.push(change), state.index++)
                          : (conflicted = !0);
                      }
                      "+" === (matchChanges[matchIndex] || "")[0] &&
                        contextChanges &&
                        (conflicted = !0);
                      if (conflicted) return changes;
                      for (; matchIndex < matchChanges.length; )
                ...
                function skipRemoveSuperset(state, removeChanges, delta) {
                  for (var i = 0; i < delta; i++) {
                    var changeContent = removeChanges[
                      removeChanges.length - delta + i
                    ].substr(1);
              ...
              function(module, exports, __webpack_require__) {
                ...
                function structuredPatch(
                  ...
                  options || (options = {}),
                    void 0 === options.context && (options.context = 4);
                    ...
                    var hunks = [],
                      ...
                      _loop = function(i) {
                        ...
                        if (
                          ...
                          if (oldRangeStart)
                            if (
                              lines.length <= 2 * options.context &&
                              i < diff.length - 2
                            ) {
                              var _curRange2;
                              ...
                              if (
                                ...
                                var oldEOFNewline = /\n$/.test(oldStr),
                                  newEOFNewline = /\n$/.test(newStr);
                                0 != lines.length || oldEOFNewline
                                  ? (oldEOFNewline && newEOFNewline) ||
                                    curRange.push(
                ...
                function createTwoFilesPatch(
                  ...
                  oldFileName == newFileName &&
                    ...
                    ret.push(
                      "--- " +
                        diff.oldFileName +
                        (void 0 === diff.oldHeader ? "" : "\t" + diff.oldHeader)
                    ),
                    ret.push(
                      "+++ " +
                        diff.newFileName +
                        (void 0 === diff.newHeader ? "" : "\t" + diff.newHeader)
                    );
              ...
              function(module, exports) {
                ...
                function arrayStartsWith(array, start) {
                  if (start.length > array.length) return !1;
                  for (var i = 0; i < start.length; i++)
                    if (start[i] !== array[i]) return !1;
                  return !0;
                }
                (exports.__esModule = !0),
                  (exports.arrayEqual = function(a, b) {
                    return a.length === b.length && arrayStartsWith(a, b);
                  }),
              ...
              function(module, exports) {
                "use strict";
                (exports.__esModule = !0),
                  (exports.convertChangesToDMP = function(changes) {
                    for (
                      var ret = [], change = void 0, operation = void 0, i = 0;
                      i < changes.length;
                      i++
                    )
                      (change = changes[i]),
              ...
              for (
                ...
                0 == state
                  ...
                  ? (tokens.push({
                      ...
                      ctag: ctag,
                      i:
                        "/" == tagType ? seenTag - otag.length : i + ctag.length
                    }),
                    (buf = ""),
                    (i += ctag.length - 1),
                    (state = 0),
            ...
            (Hogan.parse = function(tokens, text, options) {
              return (function buildTree(tokens, kind, stack, customTags) {
                var tail,
                  ...
                  opener = null,
                  token = null;
                for (tail = stack[stack.length - 1]; 0 < tokens.length; ) {
                  if (
                    ((token = tokens.shift()),
              ...
              ep: function(symbol, partials) {
                ...
                if (((this.partials[symbol].base = template), partial.subs)) {
                  ...
                  template = (function(
                    ...
                    var key;
                    Substitutions.prototype = (PartialTemplate.prototype = instance).subs;
                ...
                return (this.partials[symbol].instance = template);
              },
              ...
              s: function(val, ctx, partials, inverted, start, end, tags) {
                ...
                return (
                  ...
                  !inverted &&
                    ...
                    ctx &&
                    ctx.push(
                      "object" == typeof val ? val : ctx[ctx.length - 1]
                    ),
                  pass)
                );
              },
    ...
    8: [
      function(require, module, exports) {
        var Map = require("./_getNative")(require("./_root"), "Map");
        module.exports = Map;
      },
      { "./_getNative": 43, "./_root": 74 }
    ],
    9: [
      function(require, module, exports) {
    ...
    11: [
      function(require, module, exports) {
        var Symbol = require("./_root").Symbol;
    ...
    12: [
      function(require, module, exports) {
        var Uint8Array = require("./_root").Uint8Array;
    ...
    20: [
      function(require, module, exports) {
        var baseFor = require("./_createBaseFor")();
    ...
    21: [
      ...
      { "./_Symbol": 11, "./_getRawTag": 45, "./_objectToString": 71 }
    ],
    22: [
      function(require, module, exports) {
      ...
      { "./_baseGetTag": 21, "./isObjectLike": 95 }
    ],
    23: [
      function(require, module, exports) {
    ...
    24: [
      ...
      { "./_baseGetTag": 21, "./isLength": 93, "./isObjectLike": 95 }
    ],
    25: [
      function(require, module, exports) {
        var isObject = require("./isObject"),
      ...
      { "./_isPrototype": 57, "./_nativeKeysIn": 69, "./isObject": 94 }
    ],
    26: [
      function(require, module, exports) {
              ...
              (newValue = srcValue),
                isArr || isBuff || isTyped
                  ? (newValue = isArray(objValue)
                      ...
                      ? copyArray(objValue)
                      : isBuff
                      ? cloneBuffer(srcValue, !(isCommon = !1))
                      : isTyped
                      ? cloneTypedArray(srcValue, !(isCommon = !1))
                      : [])
                  : isPlainObject(srcValue) || isArguments(srcValue)
                  ? isArguments((newValue = objValue))
    ...
    28: [
      ...
      { "./_overRest": 73, "./_setToString": 76, "./identity": 86 }
    ],
    29: [
      function(require, module, exports) {
      ...
      { "./_defineProperty": 40, "./constant": 84, "./identity": 86 }
    ],
    30: [
      function(require, module, exports) {
    ...
    36: [
      ...
      { "./_assignValue": 16, "./_baseAssignValue": 18 }
    ],
    37: [
      function(require, module, exports) {
        var coreJsData = require("./_root")["__core-js_shared__"];
    ...
    38: [
      ...
      { "./_baseRest": 28, "./_isIterateeCall": 54 }
    ],
    39: [
      function(require, module, exports) {
    ...
    43: [
      ...
      { "./_baseIsNative": 23, "./_getValue": 46 }
    ],
    44: [
      function(require, module, exports) {
        var getPrototype = require("./_overArg")(Object.getPrototypeOf, Object);
    ...
    52: [
      ...
      { "./_baseCreate": 19, "./_getPrototype": 44, "./_isPrototype": 57 }
    ],
    53: [
      function(require, module, exports) {
    ...
    54: [
      ...
      { "./_isIndex": 53, "./eq": 85, "./isArrayLike": 89, "./isObject": 94 }
    ],
    55: [
      function(require, module, exports) {
        module.exports = function(value) {
    ...
    68: [
      function(require, module, exports) {
        var nativeCreate = require("./_getNative")(Object, "create");
    ...
    76: [
      function(require, module, exports) {
        var baseSetToString = require("./_baseSetToString"),
          setToString = require("./_shortOut")(baseSetToString);
        module.exports = setToString;
      },
      { "./_baseSetToString": 29, "./_shortOut": 77 }
    ],
    77: [
      function(require, module, exports) {
    ...
    87: [
      ...
      { "./_baseIsArguments": 22, "./isObjectLike": 95 }
    ],
    88: [
      function(require, module, exports) {
    ...
    90: [
      ...
      { "./isArrayLike": 89, "./isObjectLike": 95 }
    ],
    91: [
      function(require, module, exports) {
        var root = require("./_root"),
    ...
    96: [
      ...
      { "./_baseGetTag": 21, "./_getPrototype": 44, "./isObjectLike": 95 }
    ],
    97: [
      function(require, module, exports) {
      ...
      { "./_baseIsTypedArray": 24, "./_baseUnary": 31, "./_nodeUtil": 70 }
    ],
    98: [
      function(require, module, exports) {
      ...
      { "./_arrayLikeKeys": 14, "./_baseKeysIn": 25, "./isArrayLike": 89 }
    ],
    99: [
      function(require, module, exports) {
        var baseMerge = require("./_baseMerge"),
          merge = require("./_createAssigner")(function(
            object,
            source,
            srcIndex
          ) {
      ...
      { "./_baseMerge": 26, "./_createAssigner": 38 }
    ],
    100: [
      function(require, module, exports) {
        module.exports = function() {
      ...
      function(require, module, exports) {
        !(function() {
          ...
          function getExtension(filename, language) {
            ...
            return 1 < nameSplit.length
              ? nameSplit[nameSplit.length - 1]
              : language;
          }
          function _getFilename(linePrefix, line, extraPrefix) {
            var filename,
              prefixes = ["a/", "b/", "i/", "w/", "c/", "o/"];
            extraPrefix && prefixes.push(extraPrefix);
            var values = (linePrefix
              ? new RegExp("^" + linePrefix + ' "?(.+?)"?$')
              : new RegExp('^"?(.+?)"?$')
            ).exec(line);
            if (values && values[1]) {
              filename = values[1];
              var matchingPrefixes = prefixes.filter(function(p) {
                return 0 === filename.indexOf(p);
              });
              matchingPrefixes[0] &&
          ...
          (DiffParser.prototype.LINE_TYPE = LINE_TYPE),
            (DiffParser.prototype.generateDiffJson = function(
              diffInput,
              configuration
            ) {
              var possibleOldName,
              ...
              function saveFile() {
                currentFile &&
                  ...
                  currentFile.newName &&
                    (files.push(currentFile), (currentFile = null))),
                  (possibleNewName = possibleOldName = void 0);
              }
              function startFile() {
                saveBlock(),
                  saveFile(),
              ...
              function startBlock(line) {
                ...
                saveBlock(),
                  (values = /^@@ -(\d+)(?:,\d+)? \+(\d+)(?:,\d+)? @@.*/.exec(
                    ...
                    ? ((currentFile.isCombined = !1),
                      (oldLine = values[1]),
                      (newLine = values[2]))
                    : (values = /^@@@ -(\d+)(?:,\d+)? -(\d+)(?:,\d+)? \+(\d+)(?:,\d+)? @@@.*/.exec(
                        line
                      ))
                    ? ((currentFile.isCombined = !0),
                      (oldLine = values[1]),
                      (oldLine2 = values[2]),
                      (newLine = values[3]))
                    : (utils.startsWith(line, "@@") &&
                      ...
                      (newLine = oldLine = 0),
                      (currentFile.isCombined = !1)),
                  ((currentBlock = { lines: [] }).oldStartLine = oldLine),
              ...
              var diffLines = diffInput
                ...
                index = /^index ([0-9a-z]+)\.\.([0-9a-z]+)\s*(\d{6})?/,
                binaryFiles = /^Binary files (.*) and (.*) differ/,
                binaryDiff = /^GIT binary patch/,
              ...
              return (
                diffLines.forEach(function(line, lineIndex) {
                  if (line && !utils.startsWith(line, "*")) {
                    var values,
                      prevLine = diffLines[lineIndex - 1],
                      nxtLine = diffLines[lineIndex + 1],
                      afterNxtLine = diffLines[lineIndex + 2];
                    if (utils.startsWith(line, "diff")) {
                      startFile();
                      return (
                        (values = /^diff --git "?(.+)"? "?(.+)"?/.exec(line)) &&
                          ((possibleOldName = _getFilename(
                            null,
                            values[1],
                            config.dstPrefix
                          )),
                          (possibleNewName = _getFilename(
                            null,
                            values[2],
                            config.srcPrefix
                          ))),
                        void (currentFile.isGitDiff = !0)
                      );
                    }
                    if (
                      ((!currentFile ||
                        (!currentFile.isGitDiff &&
                          currentFile &&
                          utils.startsWith(line, "--- ") &&
                          utils.startsWith(nxtLine, "+++ ") &&
                          utils.startsWith(afterNxtLine, "@@"))) &&
                        startFile(),
                      (utils.startsWith(line, "--- ") &&
                        utils.startsWith(nxtLine, "+++ ")) ||
                        (utils.startsWith(line, "+++ ") &&
                          utils.startsWith(prevLine, "--- ")))
                    ) {
                      if (
                        currentFile &&
                        !currentFile.oldName &&
                        utils.startsWith(line, "--- ") &&
                        (values = (function(line, cfg) {
                          return _getFilename("---", line, cfg.srcPrefix);
                        })(line, config))
                      )
                        return (
                          (currentFile.oldName = values),
                          void (currentFile.language = getExtension(
                            currentFile.oldName,
                    ...
                    if (
                      (currentFile && utils.startsWith(line, "@@")) ||
                      (currentFile.isGitDiff &&
                        currentFile &&
                        currentFile.oldName &&
                        currentFile.newName &&
                      ...
                      !(function(line) {
                        ...
                        var newLinePrefixes = currentFile.isCombined
                          ...
                          delLinePrefixes = currentFile.isCombined
                            ? ["-", " -"]
                            : ["-"];
                        utils.startsWith(line, newLinePrefixes)
                          ? (currentFile.addedLines++,
                            (currentLine.type = LINE_TYPE.INSERTS),
                            (currentLine.oldNumber = null),
                            (currentLine.newNumber = newLine++))
                          : utils.startsWith(line, delLinePrefixes)
                      ...
                      var doesNotExistHunkHeader = !(function(line, lineIdx) {
                        for (var idx = lineIdx; idx < diffLines.length - 3; ) {
                          if (utils.startsWith(line, "diff")) return !1;
                          if (
                            utils.startsWith(diffLines[idx], "--- ") &&
                            utils.startsWith(diffLines[idx + 1], "+++ ") &&
                            utils.startsWith(diffLines[idx + 2], "@@")
                          )
                            return !0;
                          idx++;
                        }
                      ...
                      (values = oldMode.exec(line))
                        ? (currentFile.oldMode = values[1])
                        : (values = newMode.exec(line))
                        ? (currentFile.newMode = values[1])
                        : (values = deletedFileMode.exec(line))
                        ? ((currentFile.deletedFileMode = values[1]),
                          (currentFile.isDeleted = !0))
                        : (values = newFileMode.exec(line))
                        ? ((currentFile.newFileMode = values[1]),
                          (currentFile.isNew = !0))
                        : (values = copyFrom.exec(line))
                        ? (doesNotExistHunkHeader &&
                            (currentFile.oldName = values[1]),
                          (currentFile.isCopy = !0))
                        : (values = copyTo.exec(line))
                        ? (doesNotExistHunkHeader &&
                            (currentFile.newName = values[1]),
                          (currentFile.isCopy = !0))
                        : (values = renameFrom.exec(line))
                        ? (doesNotExistHunkHeader &&
                            (currentFile.oldName = values[1]),
                          (currentFile.isRename = !0))
                        : (values = renameTo.exec(line))
                        ? (doesNotExistHunkHeader &&
                            (currentFile.newName = values[1]),
                          (currentFile.isRename = !0))
                        : (values = binaryFiles.exec(line))
                        ? ((currentFile.isBinary = !0),
                          (currentFile.oldName = _getFilename(
                            null,
                            values[1],
                            config.srcPrefix
                          )),
                          (currentFile.newName = _getFilename(
                            null,
                            values[2],
                            config.dstPrefix
                          )),
                          startBlock("Binary file"))
                        : (values = binaryDiff.exec(line))
                        ? ((currentFile.isBinary = !0), startBlock(line))
                        : (values = similarityIndex.exec(line))
                        ? (currentFile.unchangedPercentage = values[1])
                        : (values = dissimilarityIndex.exec(line))
                        ? (currentFile.changedPercentage = values[1])
                        : (values = index.exec(line))
                        ? ((currentFile.checksumBefore = values[1]),
                          (currentFile.checksumAfter = values[2]),
                          values[3] && (currentFile.mode = values[3]))
                        : (values = combinedIndex.exec(line))
                        ? ((currentFile.checksumBefore = [
                            values[2],
                            values[3]
                          ]),
                          (currentFile.checksumAfter = values[1]))
                        : (values = combinedMode.exec(line))
                        ? ((currentFile.oldMode = [values[2], values[3]]),
                          (currentFile.newMode = values[1]))
                        : (values = combinedNewFile.exec(line))
                        ? ((currentFile.newFileMode = values[1]),
                          (currentFile.isNew = !0))
                        : (values = combinedDeletedFile.exec(line)) &&
                          ((currentFile.deletedFileMode = values[1]),
                          (currentFile.isDeleted = !0));
                    }
                  }
    ...
    105: [
        ...
        (function(global) {
          !(function() {
            var diffParser = require("./diff-parser.js").DiffParser,
              htmlPrinter = require("./html-printer.js").HtmlPrinter,
            ...
            (Diff2Html.prototype.getJsonFromDiff = function(diffInput, config) {
              ...
              (Diff2Html.prototype.getPrettyHtml = function(diffInput, config) {
                var cfg = utils.safeConfig(config, defaultConfig),
                  diffJson = diffInput;
                (cfg.inputFormat && "diff" !== cfg.inputFormat) ||
                  (diffJson = diffParser.generateDiffJson(diffInput, cfg));
                var fileList = "";
                !0 === cfg.showFiles &&
                  (fileList = htmlPrinter.generateFileListSummary(
                    diffJson,
                    cfg
                  ));
                return (
                  fileList +
                  ("side-by-side" === cfg.outputFormat
                    ? htmlPrinter.generateSideBySideJsonHtml(diffJson, cfg)
                    : htmlPrinter.generateLineByLineJsonHtml(diffJson, cfg))
                );
              }),
              (Diff2Html.prototype.getPrettyHtmlFromDiff = function(
                diffInput,
                config
              ) {
                var cfg = utils.safeConfig(config, defaultConfig);
                return (
                  ...
                  this.getPrettyHtml(diffInput, cfg)
                );
              }),
              (Diff2Html.prototype.getPrettyHtmlFromJson = function(
                diffJson,
                config
              ) {
                var cfg = utils.safeConfig(config, defaultConfig);
                return (
                  ...
                  (cfg.outputFormat = "line-by-line"),
                  this.getPrettyHtml(diffJson, cfg)
                );
              }),
              (Diff2Html.prototype.getPrettySideBySideHtmlFromDiff = function(
                diffInput,
                config
              ) {
                var cfg = utils.safeConfig(config, defaultConfig);
              ...
              (Diff2Html.prototype.getPrettySideBySideHtmlFromJson = function(
                diffJson,
                config
              ) {
                var cfg = utils.safeConfig(config, defaultConfig);
      ...
      { "./diff-parser.js": 104, "./html-printer.js": 108, "./utils.js": 114 }
    ],
    106: [
      function(require, module, exports) {
        !(function() {
          var hoganUtils,
            printerUtils = require("./printer-utils.js").PrinterUtils;
          ...
          (FileListPrinter.prototype.generateFileList = function(diffFiles) {
            var lineTemplate = hoganUtils.template("file-summary", "line"),
              files = diffFiles
                .map(function(file) {
                  var fileTypeName = printerUtils.getFileTypeIcon(file),
                    iconTemplate = hoganUtils.template("icon", fileTypeName);
                ...
                .join("\n");
            return hoganUtils.render("file-summary", "wrapper", {
      ...
      { "./hoganjs-utils.js": 107, "./printer-utils.js": 110 }
    ],
    107: [
      function(require, module, exports) {
        (function(__dirname) {
          !(function() {
            ...
            function HoganJsUtils(configuration) {
              ...
              for (var templateName in rawTemplates)
                rawTemplates.hasOwnProperty(templateName) &&
                  (extraTemplates[templateName] ||
                    (extraTemplates[templateName] = this.compile(
                      rawTemplates[templateName]
                    )));
            }
            (HoganJsUtils.prototype.render = function(namespace, view, params) {
              ...
              (HoganJsUtils.prototype._getTemplate = function(templateKey) {
                ...
                return (
                  ...
                  template || (template = this._loadTemplate(templateKey)),
                  template
                );
              }),
                ...
                try {
                  if (fs.readFileSync) {
                    var templatesPath = path.resolve(__dirname, "templates"),
                      templatePath = path.join(templatesPath, templateKey),
              ...
              (HoganJsUtils.prototype._readFromCache = function(templateKey) {
                return (
                  extraTemplates[templateKey] || hoganTemplates[templateKey]
                );
              }),
      ...
      {
        "./templates/diff2html-templates.js": 113,
        fs: 1,
        "hogan.js": 4,
        path: 102
      }
    ...
    108: [
      function(require, module, exports) {
        !(function() {
          var LineByLinePrinter = require("./line-by-line-printer.js")
              .LineByLinePrinter,
            SideBySidePrinter = require("./side-by-side-printer.js")
              .SideBySidePrinter,
            FileListPrinter = require("./file-list-printer.js").FileListPrinter;
          function HtmlPrinter() {}
          (HtmlPrinter.prototype.generateLineByLineJsonHtml = function(
            diffFiles,
            config
          ) {
            return new LineByLinePrinter(config).generateLineByLineJsonHtml(
              diffFiles
            );
          }),
            (HtmlPrinter.prototype.generateSideBySideJsonHtml = function(
              diffFiles,
              config
            ) {
              return new SideBySidePrinter(config).generateSideBySideJsonHtml(
                diffFiles
              );
            }),
            (HtmlPrinter.prototype.generateFileListSummary = function(
              diffJson,
              config
            ) {
              return new FileListPrinter(config).generateFileList(diffJson);
            }),
            (module.exports.HtmlPrinter = new HtmlPrinter());
        })();
      },
      {
        "./file-list-printer.js": 106,
        "./line-by-line-printer.js": 109,
        "./side-by-side-printer.js": 112
      }
    ],
    109: [
      function(require, module, exports) {
        !(function() {
          var hoganUtils,
            ...
            printerUtils = require("./printer-utils.js").PrinterUtils,
            utils = require("./utils.js").Utils,
            Rematch = require("./rematch.js").Rematch;
          function LineByLinePrinter(config) {
            this.config = config;
            var HoganJsUtils = require("./hoganjs-utils.js").HoganJsUtils;
            hoganUtils = new HoganJsUtils(config);
          }
          (LineByLinePrinter.prototype.makeFileDiffHtml = function(
            file,
            diffs
          ) {
            var fileDiffTemplate = hoganUtils.template(
                "line-by-line",
                "file-diff"
              ),
              filePathTemplate = hoganUtils.template("generic", "file-path"),
              fileIconTemplate = hoganUtils.template("icon", "file"),
              fileTagTemplate = hoganUtils.template(
                "tag",
                printerUtils.getFileTypeIcon(file)
              );
            return fileDiffTemplate.render({
              ...
              filePath: filePathTemplate.render(
                ...
                { fileIcon: fileIconTemplate, fileTag: fileTagTemplate }
              )
            });
          }),
            (LineByLinePrinter.prototype.makeLineByLineHtmlWrapper = function(
              ...
              return hoganUtils.render("generic", "wrapper", {
                content: content
              });
            }),
            (LineByLinePrinter.prototype.generateLineByLineJsonHtml = function(
              diffFiles
            ) {
              var that = this,
                htmlDiffs = diffFiles.map(function(file) {
                  var diffs;
                  return (
                    (diffs = file.blocks.length
                      ? that._generateFileHtml(file)
                      : that._generateEmptyDiff()),
                    that.makeFileDiffHtml(file, diffs)
                  );
                });
          ...
          (LineByLinePrinter.prototype.makeColumnLineNumberHtml = function(
            block
          ) {
            return hoganUtils.render("generic", "column-line-number", {
                ...
                .map(function(block) {
                    ...
                    var matches,
                      ...
                      doMatching =
                        oldLines.length * newLines.length <
                          (that.config.matchingMaxComparisons || 2500) &&
                        ("lines" === that.config.matching ||
                          "words" === that.config.matching);
                    (deleteType = doMatching
                      ? ((matches = matcher(oldLines, newLines)),
                        (insertType = diffParser.LINE_TYPE.INSERT_CHANGES),
                        diffParser.LINE_TYPE.DELETE_CHANGES)
                      : ((matches = [[oldLines, newLines]]),
                        (insertType = diffParser.LINE_TYPE.INSERTS),
                        diffParser.LINE_TYPE.DELETES)),
                      matches.forEach(function(match) {
                        ...
                        for (
                          ...
                          var diff = printerUtils.diffHighlight(
                            oldLine.content,
                            newLine.content,
                            that.config
                          );
                        ...
                        (lines += processedOldLines + processedNewLines),
                          (lines += that._processLines(
                            file.isCombined,
                            oldLines.slice(common),
                            newLines.slice(common)
                          ));
                      }),
                      (oldLines = []),
                      (newLines = []);
                  ...
                  for (var i = 0; i < block.lines.length; i++) {
                    ...
                    line.type !== diffParser.LINE_TYPE.INSERTS &&
                      (0 < newLines.length ||
                        (line.type !== diffParser.LINE_TYPE.DELETES &&
                          0 < oldLines.length)) &&
                      processChangeBlock(),
                      line.type === diffParser.LINE_TYPE.CONTEXT
                        ? (lines += that.makeLineHtml(
                            file.isCombined,
                            line.type,
                            line.oldNumber,
                            line.newNumber,
            ...
            (LineByLinePrinter.prototype._processLines = function(
              isCombined,
              oldLines,
              newLines
            ) {
            ...
            (LineByLinePrinter.prototype.makeLineHtml = function(
              isCombined,
              type,
              oldNumber,
              newNumber,
              ...
              var lineNumberTemplate = hoganUtils.render(
                  "line-by-line",
                  "numbers",
                  {
              ...
              if (!prefix) {
                var lineWithPrefix = printerUtils.separatePrefix(
                  isCombined,
                  content
                );
              ...
              return hoganUtils.render("generic", "line", {
                type: type,
                lineClass: "d2h-code-linenumber",
                contentClass: "d2h-code-line",
                prefix: prefix,
            ...
            (LineByLinePrinter.prototype._generateEmptyDiff = function() {
              return hoganUtils.render("generic", "empty-diff", {
                contentClass: "d2h-code-line",
                diffParser: diffParser
              });
            }),
      ...
      {
        "./diff-parser.js": 104,
        "./hoganjs-utils.js": 107,
        "./printer-utils.js": 110,
        "./rematch.js": 111,
        "./utils.js": 114
      }
    ],
    110: [
      function(require, module, exports) {
        !(function() {
          ...
          function isDevNullName(name) {
            return -1 !== name.indexOf("dev/null");
          }
          (PrinterUtils.prototype.separatePrefix = function(isCombined, line) {
            var prefix, lineWithoutPrefix;
            return (
              (lineWithoutPrefix = isCombined
                ? ((prefix = line.substring(0, 2)), line.substring(2))
                : ((prefix = line.substring(0, 1)), line.substring(1))),
              { prefix: prefix, line: lineWithoutPrefix }
            );
          }),
            ...
            (PrinterUtils.prototype.getDiffName = function(file) {
              ...
              if (
                ...
                return newFilename && !isDevNullName(newFilename)
                  ? newFilename
                  : oldFilename || "unknown/file/path";
              for (
                var prefixPaths = [],
                  suffixPaths = [],
                  oldFilenameParts = oldFilename.split("/"),
                  newFilenameParts = newFilename.split("/"),
                  i = 0,
                  j = oldFilenameParts.length - 1,
                  k = newFilenameParts.length - 1;
                i < j && i < k && oldFilenameParts[i] === newFilenameParts[i];

              )
                prefixPaths.push(newFilenameParts[i]), (i += 1);
              for (
                ;
                i < j && i < k && oldFilenameParts[j] === newFilenameParts[k];

              )
                suffixPaths.unshift(newFilenameParts[k]), (j -= 1), (k -= 1);
              var finalPrefix = prefixPaths.join("/"),
                finalSuffix = suffixPaths.join("/"),
                oldRemainingPath = oldFilenameParts.slice(i, j + 1).join("/"),
                newRemainingPath = newFilenameParts.slice(i, k + 1).join("/");
              return finalPrefix.length && finalSuffix.length
                ? finalPrefix +
                    "/{" +
                    oldRemainingPath +
                    " → " +
            ...
            (PrinterUtils.prototype.diffHighlight = function(
              diffLine1,
              diffLine2,
              config
            ) {
              var linePrefix1,
                ...
                prefixSize = 1;
              if (
                (config.isCombined && (prefixSize = 2),
              ...
              if (!config.charByChar && "words" === config.matching) {
                var treshold = 0.25;
                void 0 !== config.matchWordsThreshold &&
                ...
                matcher(
                  ...
                  1 === chunk[0].length &&
                    1 === chunk[1].length &&
                    (Rematch.distance(chunk[0][0].value, chunk[1][0].value) <
                      treshold &&
      ...
      { "./rematch.js": 111, "./utils.js": 114, diff: 2 }
    ],
    111: [
      function(require, module, exports) {
        !(function() {
          ...
          (Rematch.levenshtein = levenshtein),
            (Rematch.distance = function(x, y) {
              return (
                levenshtein((x = x.trim()), (y = y.trim())) /
                (x.length + y.length)
              );
            }),
            (Rematch.rematch = function(distanceFunction) {
              return function group(a, b, level, cache) {
                void 0 === cache && (cache = {});
                var bm = (function(a, b, cache) {
                  for (
                    var bestMatch, bestMatchDist = 1 / 0, i = 0;
                    i < a.length;
                    ++i
                  )
                    for (var j = 0; j < b.length; ++j) {
                      var md,
                        cacheKey = JSON.stringify([a[i], b[j]]);
                      cache.hasOwnProperty(cacheKey)
                        ? (md = cache[cacheKey])
                        ...
                        md < bestMatchDist &&
                          (bestMatch = {
                            indexA: i,
                            indexB: j,
                            score: (bestMatchDist = md)
                          });
                    }
                  return bestMatch;
                })(a, b, cache);
                if ((level || (level = 0), !bm || a.length + b.length < 3))
                  return [[a, b]];
                var a1 = a.slice(0, bm.indexA),
                  ...
                  result = groupMatch;
                return (
                  (0 < bm.indexA || 0 < bm.indexB) &&
                    (result = group1.concat(result)),
                  (a.length > tailA || b.length > tailB) &&
      ...
      function(require, module, exports) {
        !(function() {
          var hoganUtils,
            ...
            utils = require("./utils.js").Utils,
            Rematch = require("./rematch.js").Rematch,
            matcher = Rematch.rematch(function(a, b) {
              var amod = a.content.substr(1),
                bmod = b.content.substr(1);
              return Rematch.distance(amod, bmod);
            });
          ...
          (SideBySidePrinter.prototype.makeDiffHtml = function(file, diffs) {
            ...
            (SideBySidePrinter.prototype.generateSideBySideJsonHtml = function(
              diffFiles
            ) {
              var that = this,
                content = diffFiles
                  .map(function(file) {
                    ...
                    return (
                      (diffs = file.blocks.length
                        ? that.generateSideBySideFileHtml(file)
                        : that.generateEmptyDiff()),
                      that.makeDiffHtml(file, diffs)
                    );
                  })
                  .join("\n");
              return hoganUtils.render("generic", "wrapper", {
            ...
            (SideBySidePrinter.prototype.generateSideBySideFileHtml = function(
              file
            ) {
              var that = this,
                fileHtml = { left: "", right: "" };
            ...
            (SideBySidePrinter.prototype.processLines = function(
              isCombined,
              oldLines,
              newLines
            ) {
              for (
                var fileHtml = { left: "", right: "" },
                  maxLinesNumber = Math.max(oldLines.length, newLines.length),
                  i = 0;
                i < maxLinesNumber;
                i++
              ) {
            ...
            (SideBySidePrinter.prototype.generateSingleLineHtml = function(
              isCombined,
              type,
              number,
              content,
            ...
            (SideBySidePrinter.prototype.generateEmptyDiff = function() {
              var fileHtml = { right: "" };
              return (
                (fileHtml.left = hoganUtils.render("generic", "empty-diff", {
                  contentClass: "d2h-code-side-line",
                  diffParser: diffParser
                })),
                fileHtml
    ...
    113: [
      function(require, module, exports) {
        (function(global) {
          !(function() {
            global.browserTemplates || (global.browserTemplates = {});
              ...
              (global.browserTemplates[
                ...
                code: function(c, p, i) {
                  ...
                  return (
                    ...
                    t.b("\n" + i),
                    t.b(
                      '        <span class="d2h-file-list-title">Files changed ('
                    ),
              ...
              (global.browserTemplates[
                ...
                code: function(c, p, i) {
                  ...
                  return (
                    ...
                    t.b('<span class="d2h-file-name-wrapper">'),
                    t.b("\n" + i),
                    t.b('    <span class="d2h-icon-wrapper">'),
                    t.b(t.rp("<fileIcon0", c, p, "")),
                    t.b("</span>"),
                    t.b("\n" + i),
              ...
              (global.browserTemplates["generic-line"] = new Hogan.Template({
                code: function(c, p, i) {
                  ...
                  return (
                    ...
                    t.b('">'),
                    t.b("\n" + i),
                    t.s(t.f("prefix", c, p, 1), c, p, 0, 171, 247, "{{ }}") &&
                      (t.rs(c, p, function(c, p, t) {
                      ...
                      c.pop()),
                    t.s(t.f("content", c, p, 1), c, p, 0, 279, 353, "{{ }}") &&
                      (t.rs(c, p, function(c, p, t) {
          ...
          (Utils.prototype.escape = function(str) {
            ...
            (Utils.prototype.startsWith = function(str, start) {
              if ("object" != typeof start)
                return str && 0 === str.indexOf(start);
              var result = !1;
              return (
            ...
            (Utils.prototype.safeConfig = function(cfg, defaultConfig) {
              var newCfg = {};
              return merge(newCfg, defaultConfig, cfg), newCfg;
            }),
