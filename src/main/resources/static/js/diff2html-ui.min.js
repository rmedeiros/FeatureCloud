...
})(
  {
    1: [
      function(require, module, exports) {
        (function(global) {
          !(function() {
            var highlightJS = require("./highlight.js-internals.js")
                .HighlightJS,
              diffJson = null,
            ...
            (Diff2HtmlUI.prototype.draw = function(targetId, config) {
              ...
              $target.html(Diff2Html.getPrettyHtml(diffJson, cfg)),
                cfg.synchronisedScroll && this.synchronisedScroll($target, cfg);
            }),
              (Diff2HtmlUI.prototype.synchronisedScroll = function(targetId) {
                this._getTarget(targetId)
              ...
              (Diff2HtmlUI.prototype.fileListCloseable = function(
                targetId,
                startVisible
              ) {
                var $target = this._getTarget(targetId),
                ...
                "files-summary-show" === hashTag
                  ? show()
                  : "files-summary-hide" === hashTag
                  ? hide()
                  : startVisible
                  ? show()
                  : hide(),
              ...
              (Diff2HtmlUI.prototype.highlightCode = function(targetId) {
                this._getTarget(targetId)
                  .find(".d2h-file-wrapper")
                  .map(function(_i, file) {
                    var oldLinesState,
                      newLinesState,
                      $file = $(file),
                    ...
                    $file.find(".d2h-code-line-ctn").map(function(_j, line) {
                      ...
                      lineState =
                        -1 !== lineParent.className.indexOf("d2h-del")
                          ? oldLinesState
                          : newLinesState;
                      var result = hljs.getLanguage(language)
                        ? hljs.highlight(language, text, !0, lineState)
                        : hljs.highlightAuto(text);
                      -1 !== lineParent.className.indexOf("d2h-del")
                        ? (oldLinesState = result.top)
                        : (newLinesState =
                            (-1 !== lineParent.className.indexOf("d2h-ins") ||
                              (oldLinesState = result.top),
                            result.top));
                      var originalStream = highlightJS.nodeStream(line);
                      if (originalStream.length) {
                        var resultNode = document.createElementNS(
                          "http://www.w3.org/1999/xhtml",
                          "div"
                        );
                        (resultNode.innerHTML = result.value),
                          (result.value = highlightJS.mergeStreams(
                            originalStream,
                            highlightJS.nodeStream(resultNode),
                            text
                          ));
                      }
                      $line.addClass("hljs"),
              ...
              (Diff2HtmlUI.prototype._getTarget = function(targetId) {
                return "object" == typeof targetId && targetId instanceof jQuery
                  ? targetId
                  : "string" == typeof targetId
                  ? $(targetId)
                  : (console.error(
                      "Wrong target provided! Falling back to default value 'body'."
                    ),
                    console.log(
                      "Please provide a jQuery object or a valid DOM query string."
                    ),
                    $("body"));
              }),
              ...
              (Diff2HtmlUI.prototype._initSelection = function() {
                ...
                body.on("mousedown", ".d2h-diff-table", function(event) {
                  ...
                  target.closest(".d2h-code-line,.d2h-code-side-line").length
      ...
      function(require, module, exports) {
        !(function() {
          ...
          (HighlightJS.prototype.nodeStream = function(node) {
            ...
            (HighlightJS.prototype.mergeStreams = function(
              original,
              highlighted,
              value
            ) {
              ...
              function open(node) {
                result +=
                  ...
                  tag(node) +
                  ArrayProto.map
                    .call(node.attributes, function(a) {
